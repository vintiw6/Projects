...
def add():
    CSV.initialize_csv()
    date = get_date("Enter the date of the transaction (dd-mm-yyyy) or enter for today's date: ", allowed_default=True)
    amount = get_amount()
...
def main ():
    while True:
        ...
        print("2.View transcations and summary within a date range")
        print("3.Exit")
